...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('/admin/room/' .$rooms->id) }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        @method("PATCH")
        ...
        <br>
        <br>
        <img id="image-preview" alt="image preview" width="150px" src="{{ asset('storage/images/rooms/' . $rooms->roomImage) }}"/>
        <br/>
