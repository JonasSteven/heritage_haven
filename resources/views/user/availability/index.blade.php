            ...
            <div class="block rounded-lg p-4 shadow-xl shadow-indigo-100">
              ...
              <div class="mt-2">
                <dl>
                  ...
                  <div>
                    ...
                    <dd class="font-semibold text-dark font-['sahitya'] text-xl my-1">{{ $room->roomType }}</dd>
                    <p class="text-[12px] font-['sahitya'] tracking-wide">{{ $room->roomDesc }}</p>
                    <dd class="text-md-center text-dark mt-2 font-bold">IDR @php currency($room->roomPrice) @endphp</dd>
                  </div>
                </dl>
              ...
              <div class="flex justify-between items-center mt-7">
                ...
                <span
                  ...
                  <p class="whitespace-nowrap text-sm">{{ $room->roomQuantity }} rooms left</p>
                </span>
    
                <form action="/booking/{{ $room->id }}" method="GET">
                  @csrf
                  <input type="hidden" name="room" value="{{ old('room', $room->id) }}">
            ...
            <div class="block rounded-lg p-4 shadow-xl shadow-indigo-100">
              ...
              <div class="flex justify-between items-center mt-7">
                ...
                <form action="/booking/{{ $room->id }}" method="GET">
                  ...
                  <input type="hidden" name="totalGuest" value="{{ old('totalGuest', $totalGuest) }}">
                  <button href=""
                    class="w-40 rounded-sm hover:shadow-sm transition-all duration-300 active:scale-95 block px-6 py-2 bg-primary text-white font-['sahitya'] text-center mr-3 cursor-not-allowed" disabled>Book
                    Now</button>
                </form>
              </div>
